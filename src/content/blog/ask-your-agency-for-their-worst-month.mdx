...
We publish the floor on every account we write up for this reason. On one [kids accessories account we run](/meta-ads-agency-india/), the weakest month across seven months returned 6.95x — and we lead the case study with that rather than the 8.75x peak, because the floor is the honest promise.
