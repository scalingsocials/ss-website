...
This is also the point where traffic quality becomes readable. Cheap clicks are easy; the question is whether they convert. If add-to-carts are healthy and checkouts are not, [the constraint has moved to the site](/conversion-rate-optimisation-services/) and no campaign change will help.
