...
[Store speed](/shopify-speed-optimisation-services/) gets discussed as a score out of a hundred, which is the least useful way to think about it. The number that matters is orders, and the connection between the two is more specific than a score suggests.
