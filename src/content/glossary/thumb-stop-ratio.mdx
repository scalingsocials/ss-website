...
Use it as a creative-selection metric in the first days of a [test](/guides/meta-ads-creative-testing/), before you have enough purchases to judge anything statistically. A batch of new ads can be ranked on this within a day, and the weakest killed before they consume real budget. That is the discipline that keeps testing cheap: on one recent [Meta ads account](/meta-ads-agency-india/) we held every underperforming campaign below a few thousand rupees of lifetime spend, and the three weakest together took under eight per cent of the quarter's budget.
