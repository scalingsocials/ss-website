...
The larger point is that CPC is a middle-of-funnel vanity metric if you stop there. Traffic is not the goal. We have run [Meta ads accounts](/meta-ads-agency-india/) at under ₹2 a click that were unprofitable and accounts at ₹15 a click that were excellent, and the difference every time was what happened after the click.
